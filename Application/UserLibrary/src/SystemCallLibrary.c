...
BOOL IsWindowExist(QWORD qwWindowID)
{
	...
	return ExecuteSystemCall(SYSCALL_ISWINDOWEXIST, &stParameter);
}
...
BOOL SendEventToWindow(QWORD qwWindowID, const EVENT* pstArea)
{
	PARAMETERTABLE stParameter;
